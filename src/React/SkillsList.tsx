...
const CategoryIcons: Record<string, React.ReactNode> = {
  "Primary Mobile Stack": (
    ...
    >
      <path d="M7 2H17C18.1046 2 19 2.89543 19 4V20C19 21.1046 18.1046 22 17 22H7C5.89543 22 5 21.1046 5 20V4C5 2.89543 5.89543 2 7 2ZM7 4V20H17V4H7ZM11 17H13V19H11V17Z"></path>
    </svg>
  ),
  "Product Engineering": (
    <svg
      ...
      className="w-6 h-6 text-[var(--sec)] opacity-70"
    >
      <path d="M4 4H20V8H4V4ZM4 10H20V20H4V10ZM8 13V17H10V13H8ZM12 13V17H16V13H12Z"></path>
    </svg>
  ),
  ...
  "Infrastructure & AI Workflow": (
    <svg
      ...
      className="w-6 h-6 text-[var(--sec)] opacity-70"
    >
      <path d="M4 6C4 4.89543 4.89543 4 6 4H18C19.1046 4 20 4.89543 20 6V8H22V10H20V14H22V16H20V18C20 19.1046 19.1046 20 18 20H6C4.89543 20 4 19.1046 4 18V16H2V14H4V10H2V8H4V6ZM6 6V18H18V6H6ZM9 9H15V11H9V9ZM9 13H15V15H9V13Z"></path>
    </svg>
  ),
};
...
const SkillsList = () => {
  const [openItem, setOpenItem] = useState<string | null>(
    portfolio.skillGroups[0]?.title ?? null
  );
  ...
  return (
    <div className="text-left pt-3 md:pt-9">
      ...
      <p className="mt-3 max-w-2xl text-[var(--white-icon)] leading-7">
        Flutter stays at the center. The rest of the stack supports shipping
        products cleanly.
      </p>
      <ul className="space-y-4 mt-5 text-lg">
        {portfolio.skillGroups.map(({ title, items }) => (
